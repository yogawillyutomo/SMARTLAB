...
Stage 4C.3 remains deferred: row-span and column-span editing, multi-cell placement, geometry resize handles, span collision management, and an advanced geometry inspector are not part of Stage 4C.2.
