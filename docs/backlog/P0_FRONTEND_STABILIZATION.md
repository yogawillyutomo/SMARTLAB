...
| EX-01 Pelaksanaan Lab/laporan terpadu | kontrak S3.1 terkunci | Normal Session hanya dari source canonical; source revalidation, actual occupancy, ActivityReport 1:1, aggregate attendance, explicit Incident linkage, dan offline draft semantics sudah dikunci. | Lanjut S3.2 LaboratorySession backend lalu S3.3 ActivityReport. |
