...
export function IncidentsPage() {
  ...
  const columns: Column<Incident>[] = [
    { key: 'ticketNumber', header: 'Tiket', sortable: true, render: (i) => <button onClick={() => setDetail(i)} className="font-medium text-accent-content hover:underline">{i.ticketNumber}</button> },
  ...
  return (
    ...
    <input type="checkbox" checked={form.blocksPracticum ?? false} onChange={(e) => setForm({ ...form, blocksPracticum: e.target.checked })} className="rounded border-base-600 text-accent-content" />
