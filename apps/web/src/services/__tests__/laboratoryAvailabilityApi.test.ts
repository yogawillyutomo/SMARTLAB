...
const payload={data:{
 ...
 sourceCoverage:{schedule:{status:'covered',activePublicationCount:1},scheduleExceptions:{status:'covered'},operationalCalendar:{status:'covered'},reservations:{status:'covered'},laboratoryStatus:{status:'covered'}},
 issues:[]
}};
