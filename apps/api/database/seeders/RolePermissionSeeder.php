...
class RolePermissionSeeder extends Seeder
{
    public const ROLE_PERMISSIONS = [
        'admin-lab' => [
            ...
            'devices.view', 'devices.create', 'devices.update', 'devices.export', 'devices.manage-agent', 'telemetry.view',
            'device-transfers.create', 'device-transfers.view',
            'layouts.view', 'layouts.create', 'layouts.update', 'layouts.delete',
            'incidents.view', 'incidents.create', 'incidents.update', 'incidents.assign', 'incidents.export', 'incidents.view-all', 'incidents.view-history', 'incidents.comment',
            'work-orders.view', 'work-orders.create', 'work-orders.update', 'work-orders.assign', 'work-orders.consume-stock', 'work-orders.export',
            ...
            'calendar.view', 'calendar.create', 'calendar.update', 'calendar.cancel', 'calendar.export', 'availability.view',
        ...
        'kepala-lab' => [
            ...
            'devices.view', 'devices.export', 'telemetry.view',
            'device-transfers.view', 'layouts.view',
            'incidents.view', 'incidents.approve', 'incidents.export', 'incidents.view-all', 'incidents.view-history', 'incidents.comment',
            'work-orders.view', 'work-orders.approve', 'work-orders.export',
            'users.view', 'roles.view', 'master-data.view', 'schedules.view',
            'schedule-exceptions.view', 'schedule-exceptions.create', 'schedule-exceptions.cancel',
            'calendar.view', 'calendar.create', 'calendar.update', 'calendar.cancel', 'calendar.export', 'availability.view',
            'priority-events.view', 'priority-events.view-all', 'priority-events.create', 'priority-events.approve', 'priority-events.cancel', 'priority-events.export',
        ...
        'teknisi' => [
            'laboratories.view', 'assets.view', 'assets.update', 'stock.view',
            'maintenance.view', 'maintenance.start', 'maintenance.complete', 'maintenance.consume-stock',
            'devices.view', 'devices.update', 'devices.manage', 'devices.manage-agent', 'telemetry.view',
            'device-transfers.view', 'layouts.view', 'layouts.update',
            'incidents.view', 'incidents.update', 'incidents.view-all', 'incidents.view-history', 'incidents.comment',
            'work-orders.view', 'work-orders.update', 'work-orders.consume-stock', 'schedules.view', 'schedule-exceptions.view',
            'calendar.view', 'availability.view', 'priority-events.view', 'priority-events.view-all',
            'sessions.view', 'sessions.view-all', 'session-observations.view', 'session-observations.view-all',
            'activity-reports.view', 'activity-reports.view-all',
        ],
        'guru' => [
            'laboratories.view', 'assets.view', 'devices.view', 'loans.view', 'loans.create', 'loans.cancel',
            'incidents.view', 'incidents.create', 'incidents.comment', 'schedules.view', 'calendar.view', 'availability.view',
            'priority-events.view', 'priority-events.create', 'priority-events.cancel', 'bookings.view', 'bookings.create', 'bookings.cancel',
        ...
        'ketua-kelas' => ['incidents.view', 'incidents.create', 'incidents.comment', 'calendar.view'],
        'siswa' => ['incidents.view', 'incidents.create', 'incidents.comment', 'calendar.view'],
        'pimpinan' => [
            'laboratories.view', 'laboratories.export', 'assets.view', 'assets.export',
            'maintenance.view', 'maintenance.export', 'loans.view', 'loans.view-all', 'loans.export',
            'devices.view', 'devices.export', 'device-transfers.view', 'layouts.view',
            'incidents.view', 'incidents.export', 'incidents.view-all', 'incidents.view-history',
            'work-orders.view', 'work-orders.export', 'users.view', 'roles.view', 'schedules.view', 'schedule-exceptions.view',
            'calendar.view', 'calendar.export', 'availability.view',
    ...
    public function run(): void
    {
        ...
        foreach (RoleSeeder::ROLES as $roleKey => $roleName) {
            $keys = $roleKey === 'super-admin' ? PermissionSeeder::keys() : self::ROLE_PERMISSIONS[$roleKey];
            $ids = array_map(
