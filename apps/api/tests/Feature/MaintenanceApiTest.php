...
class MaintenanceApiTest extends TestCase
{
    ...
    {
        [$user, $school] = $this->authenticateWithPermissions(['maintenance.create-plan']);
    ...
    {
        [, $school] = $this->authenticateWithPermissions(['maintenance.create-plan', 'maintenance.schedule', 'maintenance.start']);
    ...
    {
        [, $school] = $this->authenticateWithPermissions(['maintenance.create-plan', 'maintenance.update-plan']);
        $asset = $this->asset($school);
    ...
    {
        [, $school] = $this->authenticateWithPermissions([
            'maintenance.create-plan', 'maintenance.schedule', 'maintenance.start', 'maintenance.complete',
            'stock.create', 'stock.transact',
        ]);
        $asset = $this->asset($school);
    ...
    {
        [, $school] = $this->authenticateWithPermissions([
            'maintenance.create-plan', 'maintenance.schedule', 'maintenance.start', 'maintenance.cancel',
        ]);
