...
class RequireAssetQrTokenVersionPrecondition
{
    public const ATTRIBUTE = 'asset_qr_expected_token_version';
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (! is_string($header) || preg_match('/^"([1-9][0-9]*)"$/', $header, $matches) !== 1) {
            return response()->json([
                'message' => 'A valid If-Match Asset QR token version is required.',
