...
class RequireActivityReportVersionPrecondition
{
    public const ATTRIBUTE = 'activity_report_expected_version';
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (! is_string($header) || preg_match('/^"([1-9][0-9]*)"$/', $header, $matches) !== 1) {
            return response()->json([
                'message' => 'A valid If-Match Activity Report version is required.',
